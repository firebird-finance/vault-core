...
export const maxUint256 = BigNumber.from(2)
    .pow(256)
    .sub(1);
export const maxInt128 = BigNumber.from(2)
    .pow(128)
    .sub(1);
    ...
    await ethers.provider.send("hardhat_reset", [
        {
            forking: {
                ...
                jsonRpcUrl: `https://bsc-dataseed3.ninicoin.io`
            }
        }
    ]);
}
...
export async function getLatestBlockTimeStamp(ethers: any): Promise<number> {
